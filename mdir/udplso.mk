...
# cp ../ion-open-source-4.1.1/ltp/udp/udplso.c src
...
# ../ion-open-source-4.1.1/ici/include/platform.h:865:extern int			_isprintf(char *, int, char *, ...);
# ../ion-open-source-4.1.1/ici/library/platform.c:2731:int	_isprintf(char *buffer, int bufSize, char *format, ...)
