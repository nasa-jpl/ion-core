...
# grep -rn ltpInit ../ion-open-source-4.1.1/ --exclude=*.js --exclude=*.cpp --exclude=*.supp --exclude=*.pod --exclude=*.css

# find ../ion-open-source-4.1.1/ -name ltpP.h
...
# ../ion-open-source-4.1.1/ici/library/platform_sm.c:2075:int	sm_TaskIdSelf()
